...
// Device objects
// オブジェクトを静的に確保する
const ev3api::Motor _gTailMotor(PORT_C);
const ev3api::Motor _gRightWheel(PORT_A);
const ev3api::Motor _gLeftWheel(PORT_D);
const ev3api::Motor _gArmMotor(PORT_B);
...
public:
    ...
    ev3api::Motor getArmMotor(){return _gArmMotor;};
private:
    MotorDriver(){;};
    ~MotorDriver(){;};
};

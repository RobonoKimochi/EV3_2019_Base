...
// オブジェクトを静的に確保する
const ev3api::TouchSensor _gTouchSensor(PORT_3);
const ev3api::ColorSensor _gColorSensor(PORT_4);
const ev3api::SonarSensor _gSonarSensor(PORT_1);
const ev3api::GyroSensor  _gGyroSensor(PORT_2);
